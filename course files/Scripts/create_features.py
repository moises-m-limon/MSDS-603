...
# Load data
path = 'course files/Data'
train_data = pd.read_csv(path+'/adult.data', names=col_names)
test_data = pd.read_csv(path+'/adult.test', names=col_names)
...
train_new.to_csv(path+'/processed_train_data.csv')
test_new.to_csv(path+'/processed_test_data.csv')
